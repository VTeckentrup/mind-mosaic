...
//%%%%%%%%%%%%% VARIABLEN %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	// Definition of main game graphic elements
...
//%%%%%%%%%%BUTTONS%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	public function getLoginScreen(){
		...
		username.x = 300;
		username.y = 210;
		var name:TextFormat = new TextFormat(app_font, 16, 0xbbbbbb, true);
		//Text is centered
		...
		var passw_format:TextFormat = new TextFormat(app_font, 16, 0xbbbbbb, true);
	...
	function createRegistration(){
		...
		var name2:TextFormat = new TextFormat(app_font, 16, 0xbbbbbb, true);
		//Text is centered
	...
	public function drawMenuScreen(){
		...
		// Beenden
		button6 = Button.drawButton("Beenden", Std.int(NOMINAL_WIDTH / 2), 800, "menu");
	...
	public function drawQuestionnaireScreen(type:String){
		...
		if (type == "scale") {
			...
			// item text
			var itemFormat:TextFormat = new TextFormat(app_font, 60, 0xFFFFFF, true);
			...
			var rbFormat:TextFormat = new TextFormat(app_font, 40, 0xFFFFFF, true);
...
//%%%%%%%%%%PATHOGEN PIC ASSIGNMENT%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%		
	public function drawGallery(){
		...
		var globalscore_text:TextFormat = new TextFormat(app_font, 60, 0xFFFFFF, true);
...
//%%%%%%%%%% Screens preceding MainGame %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	function DrawLevelscreen(){
		...
		var level_text:TextFormat = new TextFormat(app_font, 70, 0x000000, true);
		...
		haxe.Timer.delay(function() {drawQuestionnaireScreen("scale");},2000);
...
//%%%%%%%%%%INITIATION FUNCTION%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	function init() 
	{
		...
		// initialize for meeting version
...
//%%%%%%%%%%%% GAME %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	function MainGame(){
		...
		var scoreFormat:TextFormat = new TextFormat(app_font, 30, 0x000000, true);
		...
		levelFormat = new TextFormat(app_font, 30, 0x000000, true);
		...
		// A
		var scoreFormat_notepads:TextFormat = new TextFormat(app_font, 50, 0x000000, true);
	...
	private function endRound(drug_choice:String):Void {
		...
		{
			// call new game trial with delay of 300 ms	
			...
			// call questionnaire items with delay of 500 ms
			this.removeChild(game_screen);
