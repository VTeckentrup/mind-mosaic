...
*/
		...
		var instruction_text:TextFormat = new TextFormat(Assets.getFont("fonts/OpenSans-Regular.ttf").fontName, 50, 0x000000, true);
		instruction_text.align = TextFormatAlign.CENTER;
		//instruction_text.size = 200;
		instruction_textfield.defaultTextFormat = instruction_text;
		instruction_textfield.text = text;
