...
class AppdataJSON
{
	...
	static public function AppdataSave () {
		...
		appdata = {id:_id, mail_address:_mail_address, run:_run_ind, score:_global_score, key:_keycode, key_entered:_keycode_set, runs_played:_num_runs_played, date_last_run: _timestamp_last_run};
